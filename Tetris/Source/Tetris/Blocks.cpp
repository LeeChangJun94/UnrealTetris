...
void ABlocks::GetBlockOffset(const FName& BlockTypeName)
{
	if (BlockOffsetTable)
	{
		...
		if (BlockOffsets)
		{
			...
			//BlockArray[0]->GetStaticMeshComponent()->SetMaterial(0, BlockOffsets->BlockColor);
			BlockArray[1]->SetActorRelativeLocation(BlockOffsets->Offset2);
			//BlockArray[1]->GetStaticMeshComponent()->SetMaterial(0, BlockOffsets->BlockColor);
			BlockArray[2]->SetActorRelativeLocation(BlockOffsets->Offset3);
			//BlockArray[2]->GetStaticMeshComponent()->SetMaterial(0, BlockOffsets->BlockColor);
			BlockArray[3]->SetActorRelativeLocation(BlockOffsets->Offset4);
			//BlockArray[3]->GetStaticMeshComponent()->SetMaterial(0, BlockOffsets->BlockColor);
		}
